(function (global) {
    ...
    const QUEST_IDS = {
        ...
        LUNAR_NEW_YEAR_GIFT: String(RAW_QUEST_IDS.LUNAR_NEW_YEAR_GIFT || FALLBACK_QUEST_IDS.LUNAR_NEW_YEAR_GIFT),
        EVENT_V62_SUPPLY_GIFT: String(RAW_QUEST_IDS.EVENT_V62_SUPPLY_GIFT || FALLBACK_QUEST_IDS.EVENT_V62_SUPPLY_GIFT),
        EVENT_VETERAN_UPDATE_GIFT: String(RAW_QUEST_IDS.EVENT_VETERAN_UPDATE_GIFT || FALLBACK_QUEST_IDS.EVENT_VETERAN_UPDATE_GIFT),
        EVENT_VISIT_UPDATE_GIFT: String(RAW_QUEST_IDS.EVENT_VISIT_UPDATE_GIFT || FALLBACK_QUEST_IDS.EVENT_VISIT_UPDATE_GIFT),
    ...
    function getLegacyQuestId(questKey) {
        ...
        if (key === QUEST_IDS.LUNAR_NEW_YEAR_GIFT) return QUEST_IDS.LUNAR_NEW_YEAR_GIFT;
        if (key === QUEST_IDS.EVENT_V62_SUPPLY_GIFT) return QUEST_IDS.EVENT_V62_SUPPLY_GIFT;
        if (key === QUEST_IDS.EVENT_VETERAN_UPDATE_GIFT) return QUEST_IDS.EVENT_VETERAN_UPDATE_GIFT;
        if (key === QUEST_IDS.EVENT_VISIT_UPDATE_GIFT) return QUEST_IDS.EVENT_VISIT_UPDATE_GIFT;
        return '';
    }
