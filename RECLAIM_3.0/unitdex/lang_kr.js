...
window.UNITDEX_LANG_KR = {
    ...
    units: {
        infantry: {
            name: "보병 분대",
            role: "기본 보병",
            desc: "저렴한 비용으로 전선을 유지하는 기본 보병입니다."
        },
        rpg: {
            name: "로켓병",
            role: "대전차/대공",
        ...
        sniper: {
            name: "저격수",
            role: "초장거리 저격",
            desc: "매우 긴 사거리에서 강력한 단발을 발사합니다. (대공 불가)"
        },
        special_forces: {
            name: "특수부대",
            role: "엘리트 보병",
            desc: "높은 체력과 연사력, 은신 능력을 갖춘 정예 부대입니다."
        },
        humvee: {
            name: "험비",
            role: "고속 기동",
        ...
        apache: {
            name: "공격헬기",
            role: "지상 지원",
            desc: "AH-64 아파치. 로켓으로 지상군을 공격합니다."
        },
        md500: {
            name: "소형헬기",
            role: "공중 영웅 / 연사 제압",
            desc: "MD500. 미니건 연사로 드론·보병을 빠르게 제압하는 영웅 유닛입니다. (최대 1기)"
        },
        blackhawk: {
            name: "블랙호크",
            role: "특수부대 투입",
            desc: "지정 지점으로 이동해 특수부대 4명을 투입하고, 근접 드론을 플레어로 무력화합니다."
        },
        chinook: {
            name: "치누크",
            role: "보병 대량 투입",
            desc: "지정 지점으로 1회 이동해 보병 10명을 투입하고 상공으로 이탈합니다."
        },
        bomber: {
            name: "폭격기",
            role: "전략 폭격",
        ...
        drone_suicide: {
            name: "자폭드론",
            role: "자폭 공격",
            desc: "적에게 돌진하여 자폭합니다. 스텔스 기능."
        },
        drone_at: {
            name: "AT드론",
            role: "대전차",
            desc: "기갑 유닛에게 치명적인 범위 피해를 줍니다."
        },
        tactical_drone: {
            name: "전술드론",
            role: "정밀 타격",
        ...
        emp: {
            name: "EMP",
            role: "광역 마비",
            desc: "지정 범위의 기계 유닛을 10초간 마비시킵니다."
        },
        nuke: {
            name: "전술핵",
            role: "대량 살상",
            desc: "전술핵을 투하하여 광범위한 지역을 초토화합니다."
        },
        tactical_missile: {
            name: "전술미사일",
            role: "정밀 타격",
            desc: "본부에서 전술미사일을 발사해 지정 지점을 강타합니다."
        }
    }
};
