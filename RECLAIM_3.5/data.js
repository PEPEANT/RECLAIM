const CONFIG = {
    ...
    buildings: {
        ...
        // ===== [STap2] 생산/지원용 건물 (초기: 단순도형) =====
        supply_depot: {
            hp: 900, maxHp: 900, width: 120, height: 70, name: '보급소', canShoot: false, yOffset: 0,
            buildTime: 240, cooldown: 180, footprint: { w: 120, h: 70 }
        },
        barracks: {
            hp: 1100, maxHp: 1100, width: 130, height: 80, name: '막사', canShoot: false, yOffset: 0,
            buildTime: 300, cooldown: 200, footprint: { w: 130, h: 80 },
            producerCategories: ['infantry']
        },
        special_barracks: {
            hp: 1200, maxHp: 1200, width: 140, height: 80, name: '특수막사', canShoot: false, yOffset: 0,
            buildTime: 360, cooldown: 240, footprint: { w: 140, h: 80 },
            producerCategories: ['drone', 'special']
        },
        airfield: {
            hp: 1400, maxHp: 1400, width: 160, height: 85, name: '공항', canShoot: false, yOffset: 0,
            buildTime: 360, cooldown: 300, footprint: { w: 160, h: 85 },
            producerCategories: ['air']
        },
        research_lab: {
            hp: 1200, maxHp: 1200, width: 140, height: 85, name: '연구소', canShoot: false, yOffset: 0,
            buildTime: 420, cooldown: 300, footprint: { w: 140, h: 85 }
        },
        repair_facility: {
            hp: 1300, maxHp: 1300, width: 150, height: 85, name: '수리시설', canShoot: false, yOffset: 0,
            buildTime: 360, cooldown: 240, footprint: { w: 150, h: 85 }
        },
        tank_factory: {
            hp: 1700, maxHp: 1700, width: 170, height: 90, name: '전차공장', canShoot: false, yOffset: 0,
            buildTime: 420, cooldown: 300, footprint: { w: 170, h: 90 },
            producerCategories: ['armored']
        }
    },

    // ===== [STap2] 건설 탭 카탈로그 (UI 버튼 생성용) =====
    buildCatalog: [
        { key: 'supply_depot', icon: '📦' },
        { key: 'barracks', icon: '🏠' },
        { key: 'special_barracks', icon: '🛰️' },
        { key: 'airfield', icon: '🛫' },
        { key: 'tank_factory', icon: '🏭' },
        { key: 'repair_facility', icon: '🛠️' },
