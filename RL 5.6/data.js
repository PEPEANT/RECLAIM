const CONFIG = {
    ...
    units: {
        ...
        engineer: {
            ...
            hp: 60, damage: 15, range: 180, missileRange: 450, missileDamage: 80, speed: 0.7,
            ...
            hasMissile: true, missileCount: 1
        },
        special_forces: {
        ...
        chinook: {
            ...
            width: 145, height: 44, color: '#475569', type: 'air', category: 'air', invulnerable: true,
